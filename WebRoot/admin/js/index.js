...
layui.config({
	...
	//锁屏
	function lockPage(){
		console.log($("#lockUserName").val());
		$("#lockUserName").val('hello');
		layer.open({
			title : false,
			type : 1,
			content : $("#lock-box"),
	...
	$(".username cite").text(window.sessionStorage.getItem("username"));
	...
	layer.closeAll("page");
		if($(this).siblings(".admin-header-lock-input").val() == ''){
			...
			if($(this).siblings(".admin-header-lock-input").val() == window.sessionStorage.getItem("password")){
	...
	$(".logout").on("click",function(){
		$.post("../Logout.admin",function(data){
