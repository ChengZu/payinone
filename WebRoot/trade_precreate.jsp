...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	<div id="main">
        ...
        <form name=alipayment action="ZFBTradePreCreate" method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dd>
						...
						<span>商户网站订单系统中唯一订单号，必填（系统 自动生成）</span>
					</dd>
					<dt>订单标题：</dt>
					<dd>
						<span class="null-star">*</span>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="goodsList" />
                        <span>json,如 [{"goods_id":"goods_id001","goods_name":"全麦小面包","quantity":"1","price":"15"},{"goods_id":"goods_id002","goods_name":"黑人牙刷","quantity":"2","price":"5.05"}]</span>
                    </dd>
                    
                    <dt>商店编号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="storeId" />
                        <span>(必填) 商户门店编号</span>
                    </dd>
