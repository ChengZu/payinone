...
<%@ page import="com.github.wxpay.sdk.*" %>
<%@ page import="com.github.wxpay.sdk.WXPayConfigImpl" %>
...
<%
	 if(request.getParameter("outTradeNo")!=null){
        ...
        WXPay wxpay = new WXPay(WXPayConfigImpl.INSTANCE);
        HashMap<String, String> data = new HashMap<String, String>();
        data.put("out_trade_no", request.getParameter("outTradeNo"));
