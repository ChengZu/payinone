...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	<div id="main">
        ...
        <form name=alipayment action="WXTradePreCreate" method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="fee_type"  />
                        <span>可填,符合ISO 4217标准的三位字母代码，默认人民币：CNY</span>
                    </dd>

                    <dt>商品ID：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="product_id" />
                        <span>可填,商品的标识</span>
                    </dd>
                    <dt>设备ID：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="device_info" />
                        <span>可填,记录订单请求设备</span>
                    </dd>
